...
class Global_WS2812:
    ...
    numpix_1            = 48            # Anz. LEDs im 1. Stripe -> Lauflicht Strecke
    numpix_2            = 48            # Anz. LEDs im 2. Stripe -> Blink Ring

    seg_01_strip        = 0             #  1. Seg -> Stripe      # Lauflicht Strecke
    seg_01_start        = 0             #  1. Seg -> Start
    seg_01_count        = 48            #  1. Seg -> Anzahl
    ...
    seg_02_dir          = True          #  2. Seg -> Richtung
